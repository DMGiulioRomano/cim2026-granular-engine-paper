...
- **Stockhausen unità del tempo musicale** (p. 73): «*Pitch and rhythm can both be considered as dimensions of time*»; «*tone-color is the result of time structure*» (Stockhausen 1957, p. 19) — supporto teorico per l'idea che la struttura microtemporale (grain density, deviation_probability, IOT) determina il timbro percepito.
...
**Differenziatore frame rate non-costante.** Pp. 67–68 documentano il problema del grain-duration uniforme. PGE risolve via ParameterOrchestrator + Envelope time-varying per-voice + deviation_probability per-grain. Argomentazione di posizionamento nel paper sez. 3.
