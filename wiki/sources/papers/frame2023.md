# [Frame, 2023] Notating Experiences: A New System for Visual Documentation in Instrument Design

## Citazione CIM
Frame, C. (2023). Notating Experiences: A New System for Visual Documentation in Instrument Design. In *Proceedings of the Eighth International Conference on Technologies for Music Notation and Representation (TENOR 2023)*, pp. 22–27. Boston, MA: Northeastern University.

## Argomento centrale
Propone un sistema di notazione *descrittiva* per documentare l'esperienza d'uso di strumenti digitali (DMI), in particolare gli AirSticks. Lungo il percorso fissa con nettezza la coppia concettuale prescrittivo/descrittivo: la prima fa fare, la seconda registra ciò che è suonato.
...
- «Descriptive notation represents the sonic outcome of a work, typically used for analysis or discussion purposes.» (p. 23)
