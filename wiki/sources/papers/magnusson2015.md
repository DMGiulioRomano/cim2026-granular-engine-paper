...
## Argomento centrale
Esplora gli ambienti di live coding come sistemi notazionali: il codice è la partitura. Descrive il proprio sistema Threnoscope, in cui partiture descrittive e prescrittive si eseguono e si alterano durante la performance improvvisata.

## Gap o problema identificato
Nel live coding la notazione (il codice) coincide con l'esecuzione: il code-score viene eseguito e modificato in tempo reale, senza separazione fra specifica e suono.
...
## Note
Paper in parte autobiografico (sistema dell'autore, Thor Magnusson). Cfr. [[deferred-time-tradition]], [[interactivity-rate]].
