...
**Diretto — voce d'autorità storica per l'obiezione+risposta di «implicazioni» (sezione rimossa).** Risset 1999 è il testo CMR che articola per primo, in forma argomentativa esplicita, il *ritorno volontario al tempo differito* che il paper CIM 2026 argomenta in chiusura:
...
- **non citato nel paper** («implicazioni», sezione rimossa): precedente filosofico del ritorno
