...
- PGE separa il livello di specifica (YAML come DSL → IR dichiarativa via [[parameter-orchestrator]]) dal livello di rendering ([[renderer]] CSound/NumPy), con `ParameterOrchestrator` che valuta tendency mask prima della scrittura del .sco.
