...
Precedente diretto: l'**harmonization scheme** di Truax 1994 (F=4 con N indipendente per voce, fino a 15 voci simultanee sul DMX-1000). PGE generalizza con (a) fattore di pitch continuo non vincolato a interi armonici, espresso in qualsiasi unità (semitoni, cents, EDO arbitrario, ratio) via `PitchUnit`, (b) quattro assi indipendenti invece del solo pitch, (c) strategie stocastiche per voce con offset fisso entro l'esecuzione.
