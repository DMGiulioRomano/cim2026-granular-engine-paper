...
├── AGENTS.md                        ← this file (schema wiki)
├── Makefile                         ← `make graph`
...
- `AGENTS.md` = schema — structure conventions + operation workflows.
...
Three layers: `raw/` (immutable) → `wiki/` (LLM-generated) → `AGENTS.md` (schema).
