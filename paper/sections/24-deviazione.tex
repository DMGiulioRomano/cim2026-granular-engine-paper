...
%         (gemelli in un solo YAML: ex3_deviazione, stream mask_range +
...
%   [x] listati: un solo file (ex3_deviazione.yml) a due stream; linerange
%       49-55 (stream mask_range, blocco pointer) e 63-70 (stream
%       mask_dephase, pointer+dephase) -- riverificare se il YAML cambia
%   [x] figura unica: examples/ex3_deviazione/ex3_deviazione_map.pdf
