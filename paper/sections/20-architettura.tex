...
granulazione, scritto con un fine pedagogico per chiunque voglia acquisire
consapevolezza sulla granulazione classica. L'input è un linguaggio di dominio
...
e agnostica al modulo che la processerà; a differenza di una \emph{event list}
testuale, conserva ogni grano e ogni inviluppo come oggetto interrogabile. Questa lista alimenta
due motori di rendering audio, uno interno in NumPy e uno che genera una event-list per Csound, e tre
esportazioni: un progetto Reaper (file .rpp); una sessione Sonic Visualiser (file .sv); un export JSON. 
