...
PythonGranularEngine\notaRepo\ è un ambiente
per comporre attraverso granulazione.
È scritto con un fine pedagogico per chiunque voglia acquisire consapevolezza
sulla granulazione classica. Si discosta da una prassi
...
Questo ambiente è invece pensato per avere come input un linguaggio di dominio testuale in YAML, che espone
