...
%       (e aggiornare il rimando "§2.3" in coda a §2.2)
% =====================================================================
...
transizione è la regolarità degli istanti, non il loro numero.
    ...
    ]{examples/ex23_distribution/ex23_distribution.yml}

Su una densità abbastanza rada da risolvere i singoli onset, la
\emph{map} mostra la transizione direttamente
...
\begin{figure}[h]
    \includegraphics[width=\linewidth]{examples/ex23_distribution/ex23_distribution_map}\\
    \captionof{figure}{La \emph{map} del rendering: ascisse = tempo del
...
\begin{figure}[h]
    \includegraphics[width=\linewidth]{examples/ex23_distribution/ex23_distribution_spectrogram.pdf}\\
