...
decorrelano, mentre \texttt{pan} e \texttt{pan\_range} aprono il fornte stereofonico. La
\textsc{map} (Fig.~\ref{fig:dimensioni}) restituisce questa sovrapposizione come
un'unica texture in evoluzione. Mancano ancora la
...
\begin{figure}[h]
    ...
    Fig.~\ref{fig:pointer-MAP}). Si può osservare nitidamente la differenza di colore dettato dalla colormap a destra.
    Il colore rappresenta l'allontanamento dal pitch base del segnale.}
