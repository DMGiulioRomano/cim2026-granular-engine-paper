...
mia: già~\cite{Roads2001microsound} rileva come i parametri di controllo
...
\emph{condizioni minime di esistenza} di uno stream --- la specifica che si
...
a guadagno unitario — e restituisce dunque il materiale audio 
inalterato, indipendentemente dal suo contenuto. Il documento 
funziona così come una notazione differenziale: ciò che non 
