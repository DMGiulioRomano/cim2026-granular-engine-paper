...
\emph{condizioni minime di esistenza}(\S\ref{sec:stream-minimo}) di uno stream --- la specifica che si
...
\subsection{Le condizioni minime di esistenza}\label{sec:stream-minimo}
