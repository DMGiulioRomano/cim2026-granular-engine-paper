...
reale su DSP, il riferimento è~\cite{Truax1988realtime}.} È quella distanza
...
frammento di \texttt{ex0\_identity.yml} (Listato~\ref{lst:stream-minimo}).
    \lstinputlisting[
      linerange={3-7},
      language=yaml,
...
stacchi dal tempo del brano.
    ...
    \lstinputlisting[
      linerange={40-42}, % TODO: allineare al file reale dopo l'aggiornamento dell'envelope
      language=yaml,
      basicstyle=\ttfamily\fontsize{7.5}{9}\selectfont,
      label=lst:pointer,
