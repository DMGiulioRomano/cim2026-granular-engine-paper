...
l'architettura è la prova concreta.
% ================================================================
...
oggetto di prima classe \emph{anche dopo} la generazione è la scelta
...
e gli inviluppi --- rende interrogabile ciò che il sistema produce: lo
si può analizzare, visualizzare e confrontare dopo la generazione.
...
strategie multi-voce) è il \emph{domain language}. Un file \emph{dichiara}
le intenzioni del compositore, non descrive operazioni di sintesi.
...
La IR, dunque, è ciò che il motore ricava dallo YAML; ed è in
questa traduzione che sta la distanza fra dichiarazione e
...
Le scelte architetturali descritte hanno implicazioni compositive. Quando il controllo scende nell'intimo del
